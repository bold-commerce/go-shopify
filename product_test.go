...
func TestProductList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products.json",
...
func TestProductListFilterByIds(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/products.json",
		params,
...
func TestProductCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products/count.json",
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/products/count.json",
		params,
...
func TestProductGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products/1.json",
...
func TestProductCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", "https://fooshop.myshopify.com/admin/api/2019-04/products.json",
...
func TestProductUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", "https://fooshop.myshopify.com/admin/api/2019-04/products/1.json",
		httpmock.NewBytesResponder(200, loadFixture("product.json")))
...
func TestProductDelete(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", "https://fooshop.myshopify.com/admin/api/2019-04/products/1.json",
...
func TestProductListMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields.json",
...
func TestProductCountMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields/count.json",
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields/count.json",
		params,
		httpmock.NewStringResponder(200, `{"count": 2}`))
...
func TestProductGetMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields/2.json",
...
func TestProductCreateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields.json",
...
func TestProductUpdateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields/2.json",
		httpmock.NewBytesResponder(200, loadFixture("metafield.json")))
...
func TestProductDeleteMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", "https://fooshop.myshopify.com/admin/api/2019-04/products/1/metafields/2.json",
		httpmock.NewStringResponder(200, "{}"))
