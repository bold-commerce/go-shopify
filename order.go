...
type Order struct {
	...
	TotalDiscountSet        *decimal.Decimal        `json:"total_discount_set,omitempty"`
	CurrentTotalDiscount    *decimal.Decimal        `json:"current_total_discount,omitempty"`
	CurrentTotalDiscountSet *AmountSet              `json:"current_total_discount_set,omitempty"`
