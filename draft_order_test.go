...
func TestDraftOrderGet(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/994118539.json",
...
func TestDraftOrderCreate(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders.json",
...
func TestDraftOrderUpdate(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1.json",
...
func TestDraftOrderCount(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/count.json",
		httpmock.NewStringResponder(200, `{"count": 7}`))

	params := map[string]string{"status": "open"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/count.json",
		params,
...
func TestDraftOrderList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders.json",
...
func TestDraftOrderListOptions(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders.json",
		params,
		httpmock.NewBytesResponder(200, loadFixture("draft_orders.json")))
...
func TestDraftOrderInvoice(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"POST",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/send_invoice.json",
...
func TestDraftOrderDelete(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"DELETE",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1.json",
...
func TestDraftOrderComplete(t *testing.T) {
	...
	httpmock.RegisterResponderWithQuery(
		"PUT",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/complete.json",
		params,
		httpmock.NewBytesResponder(200, loadFixture("draft_order.json")))
...
func TestDraftOrderListMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields.json",
...
func TestDraftOrderCountMetafields(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields/count.json",
		httpmock.NewStringResponder(200, `{"count": 3}`))

	params := map[string]string{"created_at_min": "2016-01-01T00:00:00Z"}
	httpmock.RegisterResponderWithQuery(
		"GET",
		"https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields/count.json",
		params,
		httpmock.NewStringResponder(200, `{"count": 2}`))
...
func TestDraftOrderGetMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields/2.json",
...
func TestDraftOrderCreateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("POST", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields.json",
...
func TestDraftOrderUpdateMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("PUT", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields/2.json",
		httpmock.NewBytesResponder(200, loadFixture("metafield.json")))
...
func TestDraftOrderDeleteMetafield(t *testing.T) {
	...
	httpmock.RegisterResponder("DELETE", "https://fooshop.myshopify.com/admin/api/2019-04/draft_orders/1/metafields/2.json",
